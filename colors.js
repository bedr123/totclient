...
export const getButtonColor = (
  ...
  const colors = {
    ...
    bg: {
      ...
      contrast: "bg-gray-800 text-white dark:bg-white dark:text-black",
      success: "bg-emerald-600 dark:bg-emerald-500 text-black",
      danger: "bg-red-600 dark:bg-red-500 text-black",
      warning: "bg-yellow-600 dark:bg-yellow-500 text-black",
      info: "bg-blue-600 dark:bg-blue-500 text-black",
    },
    bgHover: {
    ...
    text: {
      ...
      success: "text-black dark:text-emerald-500",
      danger: "text-black dark:text-red-500",
      warning: "text-black dark:text-yellow-500",
      info: "text-black dark:text-blue-500",
    },
    outlineHover: {
      contrast:
